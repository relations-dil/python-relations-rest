...
class TestUnitTest(relations_rest.unittest.TestCase):
    ...
    def test_assertConsistent(self):
        ...
        with unittest.mock.patch('relations_rest.unittest.TestCase.assertEqual') as mock_equal:
    ...
    def test_assertContains(self):
        ...
        with unittest.mock.patch('relations_rest.unittest.TestCase.assertIn') as mock_in:
